...
case 2: //Editar Registro
	$load_query="select * from categorias where idcategoria='$id' limit 1";
...
/*		$cbx_="cbx_".$i;
	...
	$load_query="insert into categorias (idcategoria,nom_categoria,orden) values ('','$nom_categoria','$orden')";
	mysql_query($load_query) or die(mysql_error());
	header ("location: areas_productos.php");
	break;
...
/*		$cbx_="cbx_".$i;
	...
	$load_query="UPDATE categorias set nom_categoria='$nom_categoria', orden='$orden' WHERE idcategoria='$id' limit 1";
	mysql_query($load_query) or die(mysql_error());
	header ("location: areas_productos.php");
	exit;		
	break;
  ...
  <form name="form1" action="" method="post" enctype="multipart/form-data">
    <tr>
      <td height="82" colspan="2"><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="18%"><div align="right"><a href="areas_productos.php" style="color:#0000FF; font-family:Arial, Helvetica, sans-serif; font-size:11px;">Regresar</a></div></td>
        </tr>
      </table></td>
    </tr>
    <tr bgcolor="#333333"> 
    ...
    <tr> 
      ...
      <td width="588"><span style="margin-left:8px;">
        <input name="nom_categoria" type="text" class="texto5" id="nom_categoria" style="font-family:tahoma; font-size:14px; font-weight:normal; width:570px; height:25px;" value="<? echo $nom_categoria?>">
      </span></td>
    </tr>
    <tr>
