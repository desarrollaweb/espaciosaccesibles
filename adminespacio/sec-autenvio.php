...
//	mysql_query("delete from sec_emails WHERE id_email='$id' LIMIT 1") or die(mysql_error());
...
if (strlen($txt)>=3){
	...
	$vWhere =" AND CONCAT_WS(' ', a.titulo,b.nombre_email,b.email_rebote) like '%".$txt."%'";
...
$load_query="SELECT a.*,b.nombre_email FROM sec_envios a LEFT JOIN sec_usuarios b ON a.idusuario=b.idusuario WHERE a.idusuario='".$login_admin_usu_sce."'".$vWhere." ORDER BY a.fecha_inicio DESC";
...
<form name="form1" action="" method="post">
  ...
  <tr>
    ...
    <td width="443" height="42"><div style="font-family:arial; font-size:12px; font-weight:bold; color: #003366;"> &nbsp;
            ...
            <input name="sUB" type="button"  style="cursor:pointer; font-family:tahoma; font-size:10px; font-weight:normal; color:#990000; height:28px; width:130px; background: #FFDDDD" id="sUB" value="NUEVO ENVIO" onClick="javascript: iLink('sec-autenvio_new.php')">
    ...
    <td width="317" height="30"><div align="right" style="margin-right:10px;">

      <input name="txt" placeholder="Ingresar vendedor o título del envío" type="text" id="txt" value="<?php echo $txt?>" class="texto" style="width:280px; height:25px;" />

      <input type="submit" name="Buscar" id="Buscar" value="Buscar" style=" cursor:pointer; height:25px; background:#000; color:#FFFFFF" />
...
//				echo '<select name="jumpMenu"  onchange="MM_jumpMenu('."'".'parent'."'".',this,0)" style=" font-family:arial; font-size:11px; width:80px;">';
				...
				echo '<a href="?pag='.$t.'&txt='.$txt.'" class="'.$sel.'">'.$t.'</a>&nbsp; ';
  ...
  <tr>
    ...
    <table width="990" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFDDDD" style="font-family:tahoma; font-size:11px; color:#333333">
      ...
      <tr>
        ...
        <td width="43" height="28" bgcolor="#FFE8E8"><div align="center">-</div></td>



        <td width="173" bgcolor="#FFE8E8">&nbsp; <strong>Imagen</strong></td>

        <td width="268" bgcolor="#FFE8E8">&nbsp; <strong>Datos del Envio</strong></td>

        <td width="224" bgcolor="#FFE8E8">&nbsp;<strong>Vendedor(a)</strong></td>

        <td width="92" bgcolor="#FFE8E8">&nbsp; <strong>Emails</strong></td>





        <td width="103" bgcolor="#FFE8E8">&nbsp; <strong>Proceso</strong></td>

        <td width="71" bgcolor="#FFE8E8"><div align="center">-</div></td>
      ...
      <?php
		...
		if ($num_rows>=1){
			...
			while ($res=mysql_fetch_array($query)){
				...
				$pathimg="imagex.php?imgw=150&imagen=".$path.$imagen;

				$fecha_inicio=format_fech($res[fecha_inicio],"d/m/Y h:i a");
				$nombre_email=trim($res[nombre_email]);				
				$cantidad_aenviar=$res[cantidad_aenviar];
				$cantidad_enviados=$res[cantidad_enviados];
				$finalizado=$res[finalizado];
				$estado='En Cola';
				$porcentaje=0;
				if ($cantidad_enviados>=1){
					$estado='Enviando';
					$porcentaje=round($cantidad_enviados*100/$cantidad_aenviar,0);
				}
				if ($finalizado==1){
					$estado='Finalizado';
					$porcentaje=100;
				...
				$titulo=$res[titulo];
				echo '<tr onmouseout="bgColor='."'".$bgcolor."'".'"'.' onmouseover="bgColor='."'".$bgcolorrep."'".'" style=" cursor:pointer">';
				echo '<td height="25" bgcolor="#FFE8E8"><div align="center"">'.$ini.'</div></td>';
				echo '<td><div align="center" style=" margin:10px;"><img src="'.$pathimg.'" width="150" border="0"></div></td>';
				echo '<td><div style=" margin-right:5px; margin-left:5px; margin-bottom:8px; margin-top:8px;">'.$titulo.'<br>'.$fecha_inicio.'</div></td>';
				echo '<td><div style=" margin-right:5px; margin-left:5px; margin-bottom:8px; margin-top:8px;">'.$nombre_email.'</div></td>';
				echo '<td><div align="center">'.$cantidad_aenviar.'</div></td>';
				echo '<td><div align="center">'.$estado.'<br>'.$porcentaje.'%</div></td>';
//				echo '<td><div align="center"><a href="?type=ok&id='.$id_.'"><img src="imagenes/deleted.gif" width="14" height="14" border="0"></a></div></td>';
				echo '<td><div align="center"><img src="imagenes/deleted.gif" width="14" height="14" border="0"></div></td>';
				echo '</tr>';
			}
				...
				echo '<tr><td height="30" colspan="6">&nbsp;  Lo Sentimos, No hay Registros Encontrados</td></tr>';
